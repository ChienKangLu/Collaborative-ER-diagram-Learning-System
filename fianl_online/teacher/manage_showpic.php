...
<!--
                    ...
                    <div class="col-xs-12 col-md-5 text-center" style="margin-top:40px;">
                    ...
                    <div class="col-xs-12 col-md-7 text-center">
                        ...
                        <a href="#" class="btn btn-sq btn-primary" style="margin-right:30px;" onclick="showanswer(quesid);">
                            <span class="fa fa-1x glyphicon glyphicon-certificate"></span></br>
                            Show
                            <br/>
                            Answer
                        </a>
                        
                        <div id="score"  class="btn btn-sq b" >
                        </div>
                    </select>
                    </div>
            </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.9.3/js/bootstrap-select.min.js"></script>
        ...
        <script>
            ...
            function colab(name,key){
                var txt;
                txt='<button class="dropbtn co" onclick="showcolab('+key+','+quesid+');">'+name+'</button>';
                return txt;
            }
            ...
            function countscore(nowjson,answerjson){
                var score=0;
                var now=JSON.parse(nowjson);
                var answer=JSON.parse(answerjson);
                /*
                for(var i=0;i<now.length;i++){
                    for(var j=0;j<now[i].length;j++){
                        document.write(now[i][j]+"   ");
                    }
                        document.write("</br>");
                }
