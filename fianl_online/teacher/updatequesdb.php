...
$str="UPDATE `ques` SET `questitle` = '".$title."', `quescontent` = '".$content."', `tip` = '".$tip."' WHERE `ques`.`quesid` = ".$_POST['id'].";";
myinsert($str);
$str="DELETE FROM ques_entity WHERE quesid=".$_POST['id'];
myinsert($str);
$str="DELETE FROM ques_relation WHERE quesid=".$_POST['id'];
myinsert($str);
$str="DELETE FROM ques_card WHERE quesid=".$_POST['id'];
myinsert($str);
